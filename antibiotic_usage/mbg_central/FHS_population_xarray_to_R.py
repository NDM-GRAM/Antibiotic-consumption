...
in `/share/forecasting/data/5/future/population/`, create means from the draws and
save out a CSV and RDS file in `/share/geospatial/fhs-outputs/population/`
...
def get_xarray_mean(pop_version):
    """ Loads the population xarray from /share/forecasting/data/5/future/population/
    ...
    """
    filepath = (f"/share/forecasting/data/5/future/population/{pop_version}"
                "/population_agg.nc")
...
def save_out(pop_version, mean_file):
    ...
    print("Saving csv...")
    mean_file.to_csv(f"/share/geospatial/fhs-outputs/population/"
                     f"{pop_version}.csv")
    ...
    ro.r(f"saveRDS(population, file = "
         f"\'/share/geospatial/fhs-outputs/population/"
         f"{pop_version}.rds\')")
    return 0
